...
public class AppConfig {
    ...
    public List<Book> getBooks(){
        ...
        Book book1 = new Book();
        book1.setId(1L);
        book1.setTitle("Lập trình web sptring mvc");
        ...
        Book book2 = new Book();
        book2.setId(2L);
        book2.setTitle("Lập trình web sptring");
        ...
        Book book3 = new Book();
        book3.setId(3L);
        book3.setTitle("Lập trình web sptring mvc");
        ...
        Book book4 = new Book();
        book4.setId(4L);
        book4.setTitle("Lập trình web sptring mvc");
